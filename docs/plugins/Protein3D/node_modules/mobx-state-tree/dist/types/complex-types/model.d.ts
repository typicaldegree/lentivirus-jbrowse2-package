import { IAnyType, IType, _CustomOrOther, _NotCustomized, Instance, FunctionWithFlag, IStateTreeNode } from "../../internal";
/** @hidden */
...
/** @hidden */
export declare type ModelCreationType2<P extends ModelProperties, CustomC> = keyof P extends never ? IStateTreeNode : _CustomOrOther<CustomC, ModelCreationType<ExtractCFromProps<P>>>;
/** @hidden */
