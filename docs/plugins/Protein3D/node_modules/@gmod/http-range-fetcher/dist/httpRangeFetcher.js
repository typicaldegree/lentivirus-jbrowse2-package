...
const cacheSemantics_1 = require("./cacheSemantics");
const aggregatingFetcher_1 = __importDefault(require("./aggregatingFetcher"));
const crossFetchBinaryRange_1 = __importDefault(require("./crossFetchBinaryRange"));
/**
...
class HttpRangeFetcher {
     ...
     */
    constructor({ fetch = crossFetchBinaryRange_1.default, size = 10000000, chunkSize = 32768, aggregationTime = 100, minimumTTL = 1000, maxFetchSize = chunkSize * 4, maxExtraFetch = chunkSize, }) {
        ...
        this.cacheSemantics = new cacheSemantics_1.CacheSemantics({ minimumTTL });
     ...
     */
    getRange(key_1) {
        return __awaiter(this, arguments, void 0, function* (key, position = 0, requestedLength, options = {}) {
            let length = requestedLength;
            if (length === undefined) {
                const stat = yield this.stat(key);
    ...
    _makeBuffer(chunkResponses, chunksOffset, length) {
        ...
        return buffer_1.Buffer.concat([first, ...buffers, last]);
    }
    /**
    ...
    stat(key) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!stat) {
                const chunk = yield this._getChunk(key, 0);
    ...
    _getChunk(key, chunkNumber, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const freshChunk = yield freshPromise;
            // gather the stats for the file from the headers
