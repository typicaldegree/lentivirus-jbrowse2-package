...
class RpcServer {
    ...
    handler(e) {
        ...
        if (this.methods[method]) {
            Promise.resolve(data)
                ...
                .then(data => this.reply(uid, method, data), error => this.throw(uid, (0, serialize_error_1.serializeError)(error)));
        }
        else {
    ...
    reply(uid, method, data) {
        try {
            var transferables = (0, utils_1.peekTransferables)(data);
            self.postMessage({ uid, method, data, libRpc: true }, transferables);
        }
        catch (e) {
            this.throw(uid, (0, serialize_error_1.serializeError)(e));
        }
    }
    /**
     * Throw error
