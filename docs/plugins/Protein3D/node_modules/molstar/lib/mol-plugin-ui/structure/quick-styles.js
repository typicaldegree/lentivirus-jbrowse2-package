...
export class QuickStyles extends PurePluginUIComponent {
    ...
    render() {
        return _jsxs("div", { className: 'msp-flex-row', children: [_jsx(Button, { noOverflow: true, title: 'Applies default representation preset and sets outline and occlusion effects to default', onClick: () => this.default(), style: { width: 'auto' }, children: "Default" }), _jsx(Button, { noOverflow: true, title: 'Applies illustrative representation preset and Stylize it', onClick: () => this.illustrative(), style: { width: 'auto' }, children: "Illustrative" }), _jsx(Button, { noOverflow: true, title: 'Does not change representation, enables outline and occlusion effects, enables ignore-light representation parameter', onClick: () => this.stylized(), style: { width: 'auto' }, children: "Stylize Current" })] });
    }
}
