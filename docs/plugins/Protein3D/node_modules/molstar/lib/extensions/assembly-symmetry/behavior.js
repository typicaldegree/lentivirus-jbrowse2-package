...
export const AssemblySymmetry = PluginBehavior.create({
    ...
    ctor: class extends PluginBehavior.Handler {
        constructor() {
            super(...arguments);
            this.provider = AssemblySymmetryProvider;
        }
        register() {
...
})(({ a, ref, state, params }, plugin) => Task.create('Init Assembly Symmetry', async (ctx) => {
    try {
...
const AssemblySymmetry3D = PluginStateTransform.BuiltIn({
    ...
    apply({ a, params }, plugin) {
        return Task.create('Assembly Symmetry', async (ctx) => {
            ...
            const repr = AssemblySymmetryRepresentation({ webgl: (_a = plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.webgl, ...plugin.representation.structure.themes }, () => AssemblySymmetryParams);
...
export function getAssemblySymmetryConfig(plugin) {
    var _a, _b, _c, _d, _e, _f;
    return {
        ApplyColors: (_b = (_a = plugin.config.get(AssemblySymmetryConfig.ApplyColors)) !== null && _a !== void 0 ? _a : AssemblySymmetryConfig.ApplyColors.defaultValue) !== null && _b !== void 0 ? _b : true,
        DefaultServerType: (_d = (_c = plugin.config.get(AssemblySymmetryConfig.DefaultServerType)) !== null && _c !== void 0 ? _c : AssemblySymmetryConfig.DefaultServerType.defaultValue) !== null && _d !== void 0 ? _d : AssemblySymmetryDataParams.serverType.defaultValue,
        DefaultServerUrl: (_f = (_e = plugin.config.get(AssemblySymmetryConfig.DefaultServerUrl)) !== null && _e !== void 0 ? _e : AssemblySymmetryConfig.DefaultServerUrl.defaultValue) !== null && _f !== void 0 ? _f : AssemblySymmetryDataParams.serverUrl.defaultValue,
    };
}
