...
export async function setFocus(plugin, structureNodeSelector, params = MVSDefaults.focus) {
    ...
    if (structureNodeSelector) {
        ...
        else if (PluginStateObject.isRepresentation3D(cell === null || cell === void 0 ? void 0 : cell.obj)) {
            boundingSphere = getRenderObjectsBoundary(cell.obj.data.repr.renderObjects);
        }
        else if (MVSPrimitivesData.is(cell === null || cell === void 0 ? void 0 : cell.obj)) {
            const representations = plugin.state.data.selectQ(q => q.byRef(cell.transform.ref).subtree().filter(c => PluginStateObject.isRepresentation3D(c === null || c === void 0 ? void 0 : c.obj)));
