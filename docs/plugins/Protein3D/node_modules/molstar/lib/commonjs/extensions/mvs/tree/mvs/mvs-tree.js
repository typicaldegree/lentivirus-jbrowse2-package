...
const mvs_primitives_1 = require("./mvs-primitives");
    ...
    nodes: {
        ...
        transparency: {
            ...
            params: {
                ...
                transparency: (0, params_schema_1.RequiredField)(params_schema_1.float, 'Color to apply to the representation. Can be either an X11 color name (e.g. `"red"`) or a hexadecimal code (e.g. `"#FF0011"`).'),
            },
        },
        ...
        primitives: {
            ...
            params: {
                color: (0, params_schema_1.OptionalField)((0, params_schema_1.nullable)(param_types_1.ColorT)),
                label_color: (0, params_schema_1.OptionalField)((0, params_schema_1.nullable)(param_types_1.ColorT)),
                tooltip: (0, params_schema_1.OptionalField)((0, params_schema_1.nullable)(params_schema_1.str)),
                transparency: (0, params_schema_1.OptionalField)((0, params_schema_1.nullable)(params_schema_1.float)),
                label_transparency: (0, params_schema_1.OptionalField)((0, params_schema_1.nullable)(params_schema_1.float)),
                instances: (0, params_schema_1.OptionalField)((0, params_schema_1.nullable)((0, params_schema_1.list)(param_types_1.Matrix))),
            },
        },
        primitives_from_uri: {
            ...
            parent: ['structure', 'root'],
            params: {
                uri: (0, params_schema_1.RequiredField)(params_schema_1.str),
                format: (0, params_schema_1.RequiredField)((0, params_schema_1.literal)('mvs-node-json')),
                references: (0, params_schema_1.OptionalField)((0, params_schema_1.nullable)(param_types_1.StrList)),
            },
        },
        primitive: {
            ...
            params: {
                // TODO: validation
                _union_: (0, params_schema_1.RequiredField)(mvs_primitives_1.MVSPrimitiveParams),
            },
        },
    }
});
