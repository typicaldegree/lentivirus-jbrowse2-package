...
async function focusBoundingSphere(plugin, params, boundingSphere, extraRadius) {
    if (!plugin.canvas3d || !boundingSphere)
        return;
...
function getRenderObjectsBoundary(objects) {
    const spheres = [];
...
async function setFocus(plugin, structureNodeSelector, params = mvs_defaults_1.MVSDefaults.focus) {
    ...
    if (structureNodeSelector) {
        ...
        const data = (_a = cell === null || cell === void 0 ? void 0 : cell.obj) === null || _a === void 0 ? void 0 : _a.data;
        if (!data)
            console.warn('Focus: no structure');
        if (data instanceof structure_1.Structure) {
            boundingSphere = loci_1.Loci.getBoundingSphere(structure_1.Structure.Loci(data));
        }
        else if (objects_1.PluginStateObject.isRepresentation3D(cell === null || cell === void 0 ? void 0 : cell.obj)) {
            boundingSphere = getRenderObjectsBoundary(cell.obj.data.repr.renderObjects);
        }
        else if (primitives_1.MVSPrimitivesData.is(cell === null || cell === void 0 ? void 0 : cell.obj)) {
            const representations = plugin.state.data.selectQ(q => q.byRef(cell.transform.ref).subtree().filter(c => objects_1.PluginStateObject.isRepresentation3D(c === null || c === void 0 ? void 0 : c.obj)));
            const renderObjects = representations.flatMap(r => { var _a, _b, _c, _d; return (_d = (_c = (_b = (_a = r.obj) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.repr) === null || _c === void 0 ? void 0 : _c.renderObjects) !== null && _d !== void 0 ? _d : []; });
    ...
    boundingSphere !== null && boundingSphere !== void 0 ? boundingSphere : (boundingSphere = getPluginBoundingSphere(plugin));
