...
class QuickStyles extends base_1.PurePluginUIComponent {
    ...
    render() {
        return (0, jsx_runtime_1.jsxs)("div", { className: 'msp-flex-row', children: [(0, jsx_runtime_1.jsx)(common_1.Button, { noOverflow: true, title: 'Applies default representation preset and sets outline and occlusion effects to default', onClick: () => this.default(), style: { width: 'auto' }, children: "Default" }), (0, jsx_runtime_1.jsx)(common_1.Button, { noOverflow: true, title: 'Applies illustrative representation preset and Stylize it', onClick: () => this.illustrative(), style: { width: 'auto' }, children: "Illustrative" }), (0, jsx_runtime_1.jsx)(common_1.Button, { noOverflow: true, title: 'Does not change representation, enables outline and occlusion effects, enables ignore-light representation parameter', onClick: () => this.stylized(), style: { width: 'auto' }, children: "Stylize Current" })] });
    }
}
